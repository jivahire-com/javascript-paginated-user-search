...
export class UserSearch {
  ...
  setQuery(q) {
    ...
    this.debounceTimer = setTimeout(() => {
      this.debounceTimer = null;
      // Read this.page and this.query at fire time, not at schedule time.
  ...
  async _runFetch(query, page) {
    // Claim a generation token. Any response that doesn't match the
    // current generation is stale and must be discarded.
